...
public class HandVRController : MonoBehaviour {
	...
	void Update ()
    {
        ...
        rotThumb1.z = Mathf.Lerp(rotThumb1.z, 15 + (50 * thumbCurl), Time.deltaTime * smoothness);
        rotThumb1.x = Mathf.Lerp(rotThumb1.x, 270 + (30 * thumbCurl), Time.deltaTime * smoothness);
