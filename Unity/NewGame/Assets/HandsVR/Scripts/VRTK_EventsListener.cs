...
public class VRTK_EventsListener : MonoBehaviour {
    ...
    void Start () {
        ...
        VRTK_ControllerEvents controllerEvents = VRTKController.GetComponentInChildren<VRTK_ControllerEvents>();
        VRTK_InteractTouch controllerTouch = VRTKController.GetComponentInChildren<VRTK_InteractTouch>();
        grabber = VRTKController.GetComponent<VRTK_InteractGrab>();
    ...
    void Update()
    {
        ...
        Transform thumbCollider = null;
        if (handVRController.thumbCollider)
        {
            thumbCollider = handVRController.thumbCollider.otherName;
        }
